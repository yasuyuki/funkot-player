...
3. Upload the unsigned package:
   ...
   `packaging\msix\out\Funkot_0.2.0.0_x64.msix`
...
unzip -o packaging/msix/out/Funkot_0.2.0.0_x64.msix -d packaging/msix/out/run
```
...
```powershell
$msixSrc = "\\wsl.localhost\Ubuntu\home\yasuyuki\Projects\funkot-player\packaging\msix\out\Funkot_0.2.0.0_x64.msix"
# または Windows 側にコピーしたパス
$dir = Split-Path $msixSrc
$msix = Join-Path $dir "Funkot_0.2.0.0_x64.sideload.msix"
...
Partner Center には **未署名の元ファイル**（`Funkot_0.2.0.0_x64.msix`）を上げる。
